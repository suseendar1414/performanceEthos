...
def calculate_detailed_kpi_scores(data):
    ...
    for year, year_data in data.groupby('YEAR'):
        ...
        benchmark_loans = 50
        achievement_score = (closed_loans / benchmark_loans) * 100
        ...
        revenue_achievement = (total_value / benchmark_revenue) * 100
        ...
        size_achievement = (avg_loan / benchmark_avg) * 100
        ...
        rate_achievement = (approval_rate / benchmark_approval) * 100
        ...
        # 6. Time to Close (Weight: 6) - Modified calculation
